...
const S = {
  ...
  tabActive: {
    padding: '10px 20px', fontFamily: 'monospace', fontSize: '0.85rem', cursor: 'pointer',
    color: 'var(--fg)', fontWeight: 400, backgroundColor: 'transparent',
    borderTop: 'none', borderRight: 'none', borderLeft: 'none',
  ...
  tag: {
    ...
    fontFamily: 'monospace', border: '1px solid var(--border)', color: 'var(--muted)', fontWeight: 400,
  },
  tagActive: {
    display: 'inline-block', padding: '2px 8px', borderRadius: '3px', fontSize: '0.7rem',
    fontFamily: 'monospace', border: '1px solid var(--fg)', color: 'var(--fg)', fontWeight: 400,
  },
